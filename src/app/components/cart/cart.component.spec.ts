...
describe('CartComponent', () => {
  ...
  beforeEach(async () => {
    ...
    TestBed.configureTestingModule({
      ...
      providers: [ActivatedRouteProviderMock, { provide: CartService, useValue: cartServiceMock }, ],
    });
  ...
  it('should update total when discount is applied', () => {
    jest.spyOn(cartService, 'applyDiscount').mockReturnValue('Discount applied: -$50.00');
